...
void Weapon_RocketLauncher_Fire (edict_t *ent)
{
	...
	VectorSet(offset, 8, 8, ent->viewheight-8);
	P_ProjectSource (ent->client, ent->s.origin, offset, forward, right, start);
	fire_rocket (ent, start, forward, 0, 650, damage_radius, radius_damage);
	fire_rocket (ent, start, forward, damage*2, 1300, damage_radius, radius_damage);
	fire_rocket (ent, start, forward, 0, 200, damage_radius, radius_damage);
...
void weapon_railgun_fire (edict_t *ent)
{
	...
	P_ProjectSource (ent->client, ent->s.origin, offset, forward, right, start);
	fire_rail (ent, start, forward, damage-50, kick);
...
void weapon_bfg_fire (edict_t *ent)
{
	...
	VectorSet(offset, 8, 8, ent->viewheight-8);
	P_ProjectSource (ent->client, ent->s.origin, offset, forward, right, start);
	fire_bfg (ent, start, forward, 0, 400, damage_radius);
	fire_bfg (ent, start, forward, damage, 800, damage_radius);
	fire_bfg (ent, start, forward, 0, 1200, damage_radius);
